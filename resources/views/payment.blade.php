...
<div class="container-fluid" style="margin-bottom: 50px;">
    ...
    <h3>To Test Payment System, Please Fill-Up Below Token Generation Form </h3>
    <br><br>
  </div>
		<div style="padding: 0; margin: 0;" class="row">		
			...
			<div style="padding: 0; margin: 0;" class="col-md-12">
                ...
                {{-- action="https://payment.paperlessltd.com/api/v1/gateway/payment-process/initiate" method="POST" --}}
          ...
          <div class="box row">
            ...
            <div class="col-md-10" style="text-align: center;">
              {{-- {{route('')}} --}}
                    ...
                    {{-- <input type="hidden" id="muid" name="muid" value="PAPERLESS672787570e646"> --}}
                    {{-- <input type="hidden" id="access_app_key" name="access_app_key" value="UkAKIBujYNnn30U851xXy5HoP8xUtY7Td614sBJb"> --}}
                    {{-- <input type="hidden" id="merchant_order_id" name="merchant_order_id" value="1231312"> --}}
                    {{-- <input type="text" id="merchant_ref_id" name="merchant_ref_id" value="008"> --}}
